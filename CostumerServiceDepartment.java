...
public class CostumerServiceDepartment extends Department {

	public CostumerServiceDepartment(ArrayList<departments_employees.Employee> Employee) {
		super(Employee);
	...
	public String toString() {
		...
		return "CostumerServiceDepartment";
